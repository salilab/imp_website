<?php
   include("IMP.inc");
   print_page_header("IMP-commits");
?>

<div id="contact">

<p>The IMP-commits mailing list is provided for <i>developers</i> of
<a href="https://integrativemodeling.org/">IMP</a>.
It sends out an email every time code is changed in the IMP git repository.
</p>
...
<tt>SUBSCRIBE imp-commits firstname lastname</tt> where <tt>firstname</tt>
