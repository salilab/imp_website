...
IMP 2.10.0 Windows installer</h2>

<ul>
<li><a href="get.php?pkg=2.10.0/download/IMP-2.10.0-32bit.exe">For 32 bit</a></li>
<li><a href="get.php?pkg=2.10.0/download/IMP-2.10.0-64bit.exe">For 64 bit</a></li>
</ul>

<h2>Signature</h2>

<p>Please check the installer package against the
<a href="2.10.0/download/SHA256SUM">SHA256SUM</a> file
...
<a href="2.10.0/download/SHA256SUM.asc">is signed</a> with
...
of the example Python scripts) you will need to install Python 2.7,
3.4, 3.5, or 3.6
