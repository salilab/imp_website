...
<p>
<a href="http://salilab.org/imp/get.php?pkg=2.0.1/download/IMP-2.0.1.exe">Download</a>
</p>

<h2>Signature</h2>

<p>Please check the installer package against the
<a href="http://salilab.org/imp/2.0.1/download/MD5SUM">MD5SUM</a> file
...
<a href="http://salilab.org/imp/2.0.1/download/MD5SUM.asc">is signed</a> with
...
of the example Python scripts) you will need to install Python 2.4, 2.5, 2.6,
or 2.7 from <a href="http://www.python.org/">the Python website</a>.
