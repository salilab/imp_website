...
<h2>IMP 2.1.1 Linux packages</h2>

<ul>
<li>RedHat Enterprise Linux 5 RPMs (Python 2.4)<ul>
  <li>Base IMP package (needed for all users):
<a href="get.php?pkg=2.1.1/download/IMP-2.1.1-1.el5.centos.i386.rpm">32-bit</a>;
<a href="get.php?pkg=2.1.1/download/IMP-2.1.1-1.el5.centos.x86_64.rpm">x86_64</a>
  </li>
  <li>IMP-devel package (needed to compile C++ code using the IMP libraries):
<a href="get.php?pkg=2.1.1/download/IMP-devel-2.1.1-1.el5.centos.i386.rpm">32-bit</a>;
<a href="get.php?pkg=2.1.1/download/IMP-devel-2.1.1-1.el5.centos.x86_64.rpm">x86_64</a>
  </li>
...
<li>RedHat Enterprise Linux 6 RPMs (Python 2.6)<ul>
  <li>Base IMP package (needed for all users):
<a href="get.php?pkg=2.1.1/download/IMP-2.1.1-1.el6.i686.rpm">32-bit</a>;
<a href="get.php?pkg=2.1.1/download/IMP-2.1.1-1.el6.x86_64.rpm">x86_64</a>
  </li>
  <li>IMP-devel package (needed to compile C++ code using the IMP libraries):
<a href="get.php?pkg=2.1.1/download/IMP-devel-2.1.1-1.el6.i686.rpm">32-bit</a>;
<a href="get.php?pkg=2.1.1/download/IMP-devel-2.1.1-1.el6.x86_64.rpm">x86_64</a>;
  </li>
</ul>
</li>
...
<li>Fedora 19 Linux RPMs (Python 2.7, with CGAL):<ul>
  <li>Base IMP package (needed for all users):
<a href="get.php?pkg=2.1.1/download/IMP-2.1.1-1.fc19.x86_64.rpm">x86_64</a></li>
  <li>IMP-devel package (needed to compile C++ code using the IMP libraries):
<a href="get.php?pkg=2.1.1/download/IMP-devel-2.1.1-1.fc19.x86_64.rpm">x86_64</a></li>
</ul>
</ul>
...
are <a href="2.1.1/download/">also available</a>.</p>
